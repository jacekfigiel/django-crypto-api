...
from .views import home, CryptoDetailView, home_price, home_symbol, home_percent_change_24h, home_percent_change_7d, home_market_cap, home_volume_24h, home_circulating_supply
